...
- Published mtpay.ai with Caddy release path `/var/www/mtpay.ai/current`, added `mtpay-api.service`, and exposed `/api/mt-price` for same-domain MT pricing.
...
- Integrated backend price proxy for MT/USDT pricing without exposing the API key to the browser.
